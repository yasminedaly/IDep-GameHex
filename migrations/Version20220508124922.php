 ...
 */
final class Version20220508124922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE info CHANGE contentDate contentDate DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE info CHANGE contentDate contentDate DATE DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL');
    }
}
