 ...
 */
final class Version20220410230555 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coach (id INT AUTO_INCREMENT NOT NULL, rating DOUBLE PRECISION DEFAULT NULL, tier VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
