 ...
 */
final class Version20220505065132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, coach_id INT NOT NULL, title VARCHAR(25) NOT NULL, description VARCHAR(255) DEFAULT NULL, date DATE NOT NULL, start_time TIME NOT NULL, link VARCHAR(255) DEFAULT NULL, rating INT DEFAULT NULL, INDEX IDX_D044D5D43C105691 (coach_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
