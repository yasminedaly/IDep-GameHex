 ...
 */
final class Version20220507115118 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP Title, CHANGE content content VARCHAR(65534) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD Title VARCHAR(200) DEFAULT NULL, CHANGE content content LONGTEXT NOT NULL');
    }
}
